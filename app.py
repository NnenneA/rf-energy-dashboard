...
# ============================================================
    ...
    if data_loaded:
        ...
        st.dataframe(pd.DataFrame(threshold_table), width='stretch', hide_index=True)
...
# ============================================================
    ...
    if data_loaded:
        ...
        with col2:
            ...
            st.plotly_chart(fig_harvest_hour, width='stretch')
    ...
    if data_loaded:
        ...
        with col2:
            ...
            fig_prauc.update_layout(height=400, plot_bgcolor='white',
                showlegend=False, xaxis_tickangle=-30)
            st.plotly_chart(fig_prauc, width='stretch')
        ...
        with col1:
            ...
            st.dataframe(cm_data, width='stretch', hide_index=True)
